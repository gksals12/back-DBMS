...
-- 이름, 나이, 색
CREATE SEQUENCE SEQ_ANIMAL;
CREATE TABLE TBL_ANMIAL(
	ID NUMBER CONSTRAINT PK_ANIMAL PRIMARY KEY,
	ANIMAL_NAME VARCHAR2(255) NOT NULL,
	ANIMAL_AGE NUMBER,
	ANIMAL_COLOR CHAR(10) NOT NULL
);
...
CREATE TABLE TBL_COMPANY(
	...
	COMPANY_NAME VARCHAR2(255) NOT NULL,
	COMPANY_ADDRESS VARCHAR2(255) NOT NULL,
	COMPANY_CALL VARCHAR2(255) DEFAULT '000-000-0000',
...
CREATE TABLE TBL_AD(
	...
	AD_CONTENT VARCHAR2(255)
);
CREATE SEQUENCE SEQ_LARGE_AD;
CREATE TABLE TBL_LARGE_AD(
	ID NUMBER CONSTRAINT PK_LARGE_AD PRIMARY KEY,
	LARGE_AD_NAME VARCHAR2(255),
	AD_ID NUMBER,
	CONSTRAINT FK_LARGE_AD_AD FOREIGN KEY(AD_ID)
	REFERENCES TBL_AD;
);
CREATE SEQUENCE SEQ_MEDIUM_AD;
CREATE TABLE TBL_MEDIUM_AD(
	ID NUMBER CONSTRAINT PK_MEDIUM_AD PRIMARY KEY,
	MEDIUM_NAME VARCHAR2(255),
	LARGE_AD_ID NUMBER,
	CONSTRAINT FK_MEDIUM_AD_LARGE_AD FOREIGN KEY(LARGE_AD_ID)
	REFERENCES TBL_LARGE_AD
);
CREATE SEQUENCE SEQ_SMALL_AD;
CREATE TABLE TBL_SMALL_AD(
	ID NUMBER CONSTRAINT PK_SMALL_AD PRIMARY KEY,
	MEDIUM_AD_ID NUMBER,
	CONSTRAINT FK_SMALL_AD_MEDIUM_AD FOREIGN KEY(MEDIUM_AD_ID)
	REFERENCES TBL_MEDIUM_AD
);
CREATE SEQUENCE SEQ_APPLY;
CREATE TABLE TBL_APPLY(
	ID NUMBER CONSTRAINT PK_APPLY PRIMARY KEY,
