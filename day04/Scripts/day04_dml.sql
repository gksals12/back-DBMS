...
VALUES(SEQ_USER.NEXTVAL, 'hdg1234@gmail.com', '1234', '서울시 강남구', '2002-07-15');
INSERT INTO TBL_USER
...
INSERT INTO TBL_USER
VALUES(SEQ_USER.NEXTVAL, 'cjs1234@gmail.com', '1234', '화성시 동탄', '2001-02-18');

SELECT * FROM TBL_USER;

INSERT INTO TBL_POST
VALUES(SEQ_POST.NEXTVAL, '이승찬 맥북 가져다버려!', '컴퓨터는 역시 그램',1);
INSERT INTO TBL_POST
...
INSERT INTO TBL_POST
VALUES(SEQ_POST.NEXTVAL, '아직 다 못 썼어요', '제가 안썼어요! 저는 몰라요!',2);
INSERT INTO TBL_POST
...
INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '한민이형 나의 도구', 6, 4);
INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '한민이형 밤 좀 사줘요', 6, 5);
INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '그램보단 콩순이', 2, 1);
INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '갤럭시 북 세일 할 때 사세요', 1, 4);
INSERT INTO TBL_REPLY
...
-- 댓글을 단 사용자의 ID 와 거주지 조회
SELECT ID AS "댓글 단 아이디", USER_ADDRESS AS "댓글 단 주소"
FROM TBL_USER
WHERE ID IN (
	SELECT USER_ID
	FROM TBL_REPLY
...
FROM TBL_REPLY; -- 총 댓글 수

SELECT POST_ID ,COUNT(POST_ID) 
FROM TBL_REPLY
GROUP BY POST_ID; -- 포스트 마다 달린 댓글 개수
